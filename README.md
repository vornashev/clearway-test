...
Реализацию можно посмотреть здесь - https://vornashev.github.io/clearway-test
...
- С Angular 21 zoneless включен по дефолту, а так как приложение на сигналах zone.js можно удалить из зависимостей, меньше бандл
...
- В рамках проекта хранение аннотаций `AnnotationService`, в дальнейшем, если будет отдельный api метод для получения аннотаций можно быстро его реализовать, не затрагивая сущности страницы

## Улучшения, которые можно было бы реализовать дополнительно

- Производительность при больших объемах страниц и аннотаций можно реализовать через virtual scroll
