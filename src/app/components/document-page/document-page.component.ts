...
import { AddAnnotationComponent, AddAnnotationResult } from "../add-annotation/add-annotation.component";
...
@Component({
	...
	standalone: true,
	imports: [ZoomImageDirective, DraggableDirective, AddAnnotationComponent, AnnotationComponent],
